...
class MultiHeadAttention_nonlinear(Layer):
  ...
  def __init__(self,
               ...
               **kwargs):
    super(MultiHeadAttention_nonlinear, self).__init__(**kwargs)
  ...
  def get_config(self):
    ...
    base_config = super(MultiHeadAttention_nonlinear, self).get_config()
